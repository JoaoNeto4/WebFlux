...
class UserServiceTest {
    ...
    @Test
    void testSave() {
        UserRequest request = new UserRequest("joao", "joao@joao.com", "123");
        ...
        StepVerifier.create(result)
				//.expectNextMatches(user -> user instanceof User) //equivalent
				//.expectNextMatches(user -> user != null)         //equivalent
        		//.expectNextMatches(Objects::nonNull)             //equivalent
    ...
    void testHandleNotFound() {
        ...
        try {
            ...
            assertEquals(format("Object not found. Id: %s, Type: %s", "1123", User.class.getSimpleName()), ex.getMessage());
        }
    }
