package br.com.webflux.javaWebFlux.controller;
...
class UserControllerImplTest {
    ...
    //Mock database to not connect to the real database
    ...
    void testSaveWithBadRequest() {
        ...
        webTestClient.post().uri(BASE_URI)
                ...
                .jsonPath("$.errors[0].message").isEqualTo("Field cannot have blank at the beginning or at end.");
